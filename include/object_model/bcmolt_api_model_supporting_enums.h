...
typedef enum
{
    ...
    BCMOLT_CHIP_FAMILY_CHIP_FAMILY_6862_X_ = 1, 
    BCMOLT_CHIP_FAMILY_CHIP_FAMILY_6865_X_ = 2, 
...
#define bcmolt_obj_id_full_mask 0x1E87FF83F2
...
typedef enum
{
    ...
    BCMOLT_API_GROUP_ID_DEVICE_KEY = 0, 
    BCMOLT_API_GROUP_ID_DEVICE_CFG = 1, 
    BCMOLT_API_GROUP_ID_DEVICE_CONNECT = 2, 
    BCMOLT_API_GROUP_ID_DEVICE_DISCONNECT = 3, 
    BCMOLT_API_GROUP_ID_DEVICE_RESET = 4, 
    BCMOLT_API_GROUP_ID_DEVICE_HOST_KEEP_ALIVE = 5, 
    BCMOLT_API_GROUP_ID_DEVICE_SW_UPGRADE_ACTIVATE = 6, 
    BCMOLT_API_GROUP_ID_DEVICE_SET_8021_AS_TOD_STRING = 7, 
    BCMOLT_API_GROUP_ID_DEVICE_IMAGE_TRANSFER_START = 8, 
    BCMOLT_API_GROUP_ID_DEVICE_IMAGE_TRANSFER_DATA = 9, 
    BCMOLT_API_GROUP_ID_DEVICE_RUN_DDR_TEST = 10, 
    BCMOLT_API_GROUP_ID_DEVICE_DEVICE_READY = 11, 
    BCMOLT_API_GROUP_ID_DEVICE_CONNECTION_ESTABLISHED = 12, 
    BCMOLT_API_GROUP_ID_DEVICE_DEVICE_KEEP_ALIVE = 13, 
    BCMOLT_API_GROUP_ID_DEVICE_CONNECTION_FAILURE = 14, 
    BCMOLT_API_GROUP_ID_DEVICE_CONNECTION_COMPLETE = 15, 
    BCMOLT_API_GROUP_ID_DEVICE_DISCONNECTION_COMPLETE = 16, 
    BCMOLT_API_GROUP_ID_DEVICE_SW_ERROR = 17, 
    BCMOLT_API_GROUP_ID_DEVICE_SW_EXCEPTION = 18, 
    BCMOLT_API_GROUP_ID_DEVICE_IMAGE_TRANSFER_COMPLETE = 19, 
    BCMOLT_API_GROUP_ID_DEVICE_DDR_TEST_COMPLETE = 20, 
    BCMOLT_API_GROUP_ID_DEVICE_AUTO_CFG = 21, 
    BCMOLT_API_GROUP_ID_ERPS_INTERFACE_KEY = 22, 
    BCMOLT_API_GROUP_ID_ERPS_INTERFACE_CFG = 23, 
    BCMOLT_API_GROUP_ID_ERPS_INTERFACE_SET_RING_PORT_CONTROL = 24, 
    BCMOLT_API_GROUP_ID_ERPS_INTERFACE_RING_PORT_CONTROL = 25, 
    BCMOLT_API_GROUP_ID_ERPS_INTERFACE_AUTO_CFG = 26, 
    BCMOLT_API_GROUP_ID_ETH_OAM_KEY = 27, 
    BCMOLT_API_GROUP_ID_ETH_OAM_CFG = 28, 
    BCMOLT_API_GROUP_ID_ETH_OAM_CCM_EVENT = 29, 
    BCMOLT_API_GROUP_ID_ETH_OAM_SET_MEP_STATE = 30, 
    BCMOLT_API_GROUP_ID_ETH_OAM_STATE_CHANGE = 31, 
    BCMOLT_API_GROUP_ID_ETH_OAM_AUTO_CFG = 32, 
    BCMOLT_API_GROUP_ID_FLOW_CFG = 33, 
    BCMOLT_API_GROUP_ID_FLOW_KEY = 34, 
    BCMOLT_API_GROUP_ID_FLOW_SEND_ETH_PACKET = 35, 
    BCMOLT_API_GROUP_ID_FLOW_RECEIVE_ETH_PACKET = 36, 
    BCMOLT_API_GROUP_ID_FLOW_AUTO_CFG = 37, 
    BCMOLT_API_GROUP_ID_GPIO_KEY = 38, 
    BCMOLT_API_GROUP_ID_GPIO_CFG = 39, 
    BCMOLT_API_GROUP_ID_GROUP_CFG = 40, 
    BCMOLT_API_GROUP_ID_GROUP_KEY = 41, 
    BCMOLT_API_GROUP_ID_GROUP_MEMBERS_UPDATE = 42, 
    BCMOLT_API_GROUP_ID_GROUP_COMPLETE_MEMBERS_UPDATE = 43, 
    BCMOLT_API_GROUP_ID_GROUP_AUTO_CFG = 44, 
    BCMOLT_API_GROUP_ID_INBAND_MGMT_CHANNEL_CFG = 45, 
    BCMOLT_API_GROUP_ID_INBAND_MGMT_CHANNEL_KEY = 46, 
    BCMOLT_API_GROUP_ID_INTERNAL_NNI_KEY = 47, 
    BCMOLT_API_GROUP_ID_INTERNAL_NNI_CFG = 48, 
    BCMOLT_API_GROUP_ID_INTERNAL_NNI_STATUS_CHANGED = 49, 
    BCMOLT_API_GROUP_ID_INTERNAL_NNI_AUTO_CFG = 50, 
    BCMOLT_API_GROUP_ID_ITUPON_ALLOC_KEY = 51, 
    BCMOLT_API_GROUP_ID_ITUPON_ALLOC_CFG = 52, 
    BCMOLT_API_GROUP_ID_ITUPON_ALLOC_CONFIGURATION_COMPLETED = 53, 
    BCMOLT_API_GROUP_ID_ITUPON_ALLOC_GET_STATS = 54, 
    BCMOLT_API_GROUP_ID_ITUPON_ALLOC_GET_ALLOC_STATS_COMPLETED = 55, 
    BCMOLT_API_GROUP_ID_ITUPON_ALLOC_SET_STATE = 56, 
    BCMOLT_API_GROUP_ID_ITUPON_ALLOC_AUTO_CFG = 57, 
    BCMOLT_API_GROUP_ID_ITUPON_GEM_KEY = 58, 
    BCMOLT_API_GROUP_ID_ITUPON_GEM_CFG = 59, 
    BCMOLT_API_GROUP_ID_ITUPON_GEM_CONFIGURATION_COMPLETED = 60, 
    BCMOLT_API_GROUP_ID_ITUPON_GEM_SET_STATE = 61, 
    BCMOLT_API_GROUP_ID_ITUPON_GEM_AUTO_CFG = 62, 
    BCMOLT_API_GROUP_ID_LOG_KEY = 63, 
    BCMOLT_API_GROUP_ID_LOG_CFG = 64, 
    BCMOLT_API_GROUP_ID_LOG_FILE_KEY = 65, 
    BCMOLT_API_GROUP_ID_LOG_FILE_CFG = 66, 
    BCMOLT_API_GROUP_ID_LOG_FILE_CLEAR = 67, 
    BCMOLT_API_GROUP_ID_LOG_FILE_RESET_BUFFER_PTR = 68, 
    BCMOLT_API_GROUP_ID_NGPON2_CHANNEL_KEY = 69, 
    BCMOLT_API_GROUP_ID_NGPON2_CHANNEL_CFG = 70, 
    BCMOLT_API_GROUP_ID_NNI_INTERFACE_KEY = 71, 
    BCMOLT_API_GROUP_ID_NNI_INTERFACE_STATE_CHANGE = 72, 
    BCMOLT_API_GROUP_ID_NNI_INTERFACE_CFG = 73, 
    BCMOLT_API_GROUP_ID_NNI_INTERFACE_SET_NNI_STATE = 74, 
    BCMOLT_API_GROUP_ID_NNI_INTERFACE_LINK_STATE_CHANGE = 75, 
    BCMOLT_API_GROUP_ID_NNI_INTERFACE_AUTO_CFG = 76, 
    BCMOLT_API_GROUP_ID_OLT_KEY = 77, 
    BCMOLT_API_GROUP_ID_OLT_CFG = 78, 
    BCMOLT_API_GROUP_ID_OLT_CONNECT = 79, 
    BCMOLT_API_GROUP_ID_OLT_CONNECTED = 80, 
    BCMOLT_API_GROUP_ID_OLT_DISCONNECT = 81, 
    BCMOLT_API_GROUP_ID_OLT_BAL_RESET = 82, 
    BCMOLT_API_GROUP_ID_OLT_DISCONNECTED = 83, 
    BCMOLT_API_GROUP_ID_OLT_BAL_FAILURE = 84, 
    BCMOLT_API_GROUP_ID_OLT_BAL_READY = 85, 
    BCMOLT_API_GROUP_ID_OLT_SW_ERROR = 86, 
    BCMOLT_API_GROUP_ID_OLT_RESET = 87, 
    BCMOLT_API_GROUP_ID_OLT_AUTO_CFG = 88, 
    BCMOLT_API_GROUP_ID_ONU_KEY = 89, 
    BCMOLT_API_GROUP_ID_ONU_CFG = 90, 
    BCMOLT_API_GROUP_ID_ONU_SET_ONU_STATE = 91, 
    BCMOLT_API_GROUP_ID_ONU_RSSI_MEASUREMENT = 92, 
    BCMOLT_API_GROUP_ID_ONU_REQUEST_REGISTRATION = 93, 
    BCMOLT_API_GROUP_ID_ONU_CHANGE_POWER_LEVELLING = 94, 
    BCMOLT_API_GROUP_ID_ONU_GET_POWER_LEVEL = 95, 
    BCMOLT_API_GROUP_ID_ONU_GET_POWER_CONSUMPTION = 96, 
    BCMOLT_API_GROUP_ID_ONU_ADJUST_TX_WAVELENGTH = 97, 
    BCMOLT_API_GROUP_ID_ONU_SECURE_MUTUAL_AUTHENTICATION = 98, 
    BCMOLT_API_GROUP_ID_ONU_TUNING_IN = 99, 
    BCMOLT_API_GROUP_ID_ONU_TUNING_OUT = 100, 
    BCMOLT_API_GROUP_ID_ONU_XGPON_ALARM = 101, 
    BCMOLT_API_GROUP_ID_ONU_GPON_ALARM = 102, 
    BCMOLT_API_GROUP_ID_ONU_DOWI = 103, 
    BCMOLT_API_GROUP_ID_ONU_SFI = 104, 
    BCMOLT_API_GROUP_ID_ONU_SDI = 105, 
    BCMOLT_API_GROUP_ID_ONU_DFI = 106, 
    BCMOLT_API_GROUP_ID_ONU_PQSI = 107, 
    BCMOLT_API_GROUP_ID_ONU_SUFI = 108, 
    BCMOLT_API_GROUP_ID_ONU_TIWI = 109, 
    BCMOLT_API_GROUP_ID_ONU_LOOCI = 110, 
    BCMOLT_API_GROUP_ID_ONU_LOAI = 111, 
    BCMOLT_API_GROUP_ID_ONU_DGI = 112, 
    BCMOLT_API_GROUP_ID_ONU_PEE = 113, 
    BCMOLT_API_GROUP_ID_ONU_PST = 114, 
    BCMOLT_API_GROUP_ID_ONU_RANGING_COMPLETED = 115, 
    BCMOLT_API_GROUP_ID_ONU_ONU_ACTIVATION_COMPLETED = 116, 
    BCMOLT_API_GROUP_ID_ONU_ONU_DEACTIVATION_COMPLETED = 117, 
    BCMOLT_API_GROUP_ID_ONU_ONU_ENABLE_COMPLETED = 118, 
    BCMOLT_API_GROUP_ID_ONU_ONU_DISABLE_COMPLETED = 119, 
    BCMOLT_API_GROUP_ID_ONU_RSSI_MEASUREMENT_COMPLETED = 120, 
    BCMOLT_API_GROUP_ID_ONU_INVALID_DBRU_REPORT = 121, 
    BCMOLT_API_GROUP_ID_ONU_KEY_EXCHANGE_COMPLETED = 122, 
    BCMOLT_API_GROUP_ID_ONU_KEY_EXCHANGE_KEY_REQUEST_TIMEOUT = 123, 
    BCMOLT_API_GROUP_ID_ONU_KEY_EXCHANGE_CYCLE_SKIPPED = 124, 
    BCMOLT_API_GROUP_ID_ONU_KEY_EXCHANGE_KEY_MISMATCH = 125, 
    BCMOLT_API_GROUP_ID_ONU_OPTICAL_REFLECTION = 126, 
    BCMOLT_API_GROUP_ID_ONU_LOKI = 127, 
    BCMOLT_API_GROUP_ID_ONU_MEMI = 128, 
    BCMOLT_API_GROUP_ID_ONU_OMCI_PORT_ID_CONFIGURATION_COMPLETED = 129, 
    BCMOLT_API_GROUP_ID_ONU_BER_INTERVAL_CONFIGURATION_COMPLETED = 130, 
    BCMOLT_API_GROUP_ID_ONU_ERR = 131, 
    BCMOLT_API_GROUP_ID_ONU_PASSWORD_AUTHENTICATION_COMPLETED = 132, 
    BCMOLT_API_GROUP_ID_ONU_KEY_EXCHANGE_UNCONSECUTIVE_INDEX = 133, 
    BCMOLT_API_GROUP_ID_ONU_KEY_EXCHANGE_DECRYPT_REQUIRED = 134, 
    BCMOLT_API_GROUP_ID_ONU_ONU_ACTIVATION_STANDBY_COMPLETED = 135, 
    BCMOLT_API_GROUP_ID_ONU_POWER_MANAGEMENT_STATE_CHANGE = 136, 
    BCMOLT_API_GROUP_ID_ONU_POSSIBLE_DRIFT = 137, 
    BCMOLT_API_GROUP_ID_ONU_REGISTRATION_ID = 138, 
    BCMOLT_API_GROUP_ID_ONU_POWER_LEVEL_REPORT = 139, 
    BCMOLT_API_GROUP_ID_ONU_POWER_CONSUMPTION_REPORT = 140, 
    BCMOLT_API_GROUP_ID_ONU_SECURE_MUTUAL_AUTHENTICATION_FAILURE = 141, 
    BCMOLT_API_GROUP_ID_ONU_ONU_TUNING_OUT_COMPLETED = 142, 
    BCMOLT_API_GROUP_ID_ONU_ONU_TUNING_IN_COMPLETED = 143, 
    BCMOLT_API_GROUP_ID_ONU_TUNING_RESPONSE = 144, 
    BCMOLT_API_GROUP_ID_ONU_PLOAM_PACKET = 145, 
    BCMOLT_API_GROUP_ID_ONU_CPU_PACKETS = 146, 
    BCMOLT_API_GROUP_ID_ONU_CPU_PACKET = 147, 
    BCMOLT_API_GROUP_ID_ONU_OMCI_PACKET = 148, 
    BCMOLT_API_GROUP_ID_ONU_ONU_READY_FOR_DATA_GRANT = 149, 
    BCMOLT_API_GROUP_ID_ONU_REI = 150, 
    BCMOLT_API_GROUP_ID_ONU_FORCE_DEACTIVATION = 151, 
    BCMOLT_API_GROUP_ID_ONU_STATE_CHANGE = 152, 
    BCMOLT_API_GROUP_ID_ONU_AUTO_CFG = 153, 
    BCMOLT_API_GROUP_ID_PBIT_TO_TC_KEY = 154, 
    BCMOLT_API_GROUP_ID_PBIT_TO_TC_CFG = 155, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_KEY = 156, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_CFG = 157, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_SET_PON_INTERFACE_STATE = 158, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_SET_ONU_STATE = 159, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_RESET = 160, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_DISABLE_SERIAL_NUMBER = 161, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_SINGLE_REQUEST_STANDBY_PON_MONITORING = 162, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_RUN_SPECIAL_BW_MAP = 163, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_TOD_REQUEST = 164, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_START_ONU_UPGRADE = 165, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_ABORT_ONU_UPGRADE = 166, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_PROTECTION_SWITCHING_TYPE_C_SET_MULTIPLE_ONU_STATE = 167, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_PROTECTION_SWITCHING_APPLY_RERANGE_DELTA = 168, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_CPU_PACKETS = 169, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_BROADCAST_PLOAM_PACKET = 170, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_STATE_CHANGE_COMPLETED = 171, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_TOD_REQUEST_COMPLETED = 172, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_LOS = 173, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_SERIAL_NUMBER_ACQUISITION_CYCLE_START = 174, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_PROTECTION_SWITCHING_TRAFFIC_RESUME = 175, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_PROTECTION_SWITCHING_ONUS_RANGED = 176, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_PROTECTION_SWITCHING_RERANGE_FAILURE = 177, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_PROTECTION_SWITCHING_SWITCHOVER_COMPLETED = 178, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_STANDBY_PON_MONITORING_CYCLE_COMPLETED = 179, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_ONU_DISCOVERED = 180, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_CPU_PACKETS_FAILURE = 181, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_DEACTIVATE_ALL_ONUS_COMPLETED = 182, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_DISABLE_ALL_ONUS_COMPLETED = 183, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_ACTIVATE_ALL_ONUS_COMPLETED = 184, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_ENABLE_ALL_ONUS_COMPLETED = 185, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_ONU_UPGRADE_COMPLETE = 186, 
    BCMOLT_API_GROUP_ID_PON_INTERFACE_AUTO_CFG = 187, 
    BCMOLT_API_GROUP_ID_PROTECTION_INTERFACE_KEY = 188, 
    BCMOLT_API_GROUP_ID_PROTECTION_INTERFACE_CFG = 189, 
    BCMOLT_API_GROUP_ID_PROTECTION_INTERFACE_PROTECTION_SWITCH = 190, 
    BCMOLT_API_GROUP_ID_PROTECTION_INTERFACE_PROTECTION_SWITCH_COMPLETED = 191, 
    BCMOLT_API_GROUP_ID_PROTECTION_INTERFACE_AUTO_CFG = 192, 
    BCMOLT_API_GROUP_ID_SOFTWARE_ERROR_KEY = 193, 
    BCMOLT_API_GROUP_ID_SOFTWARE_ERROR_CFG = 194, 
    BCMOLT_API_GROUP_ID_TC_TO_QUEUE_KEY = 195, 
    BCMOLT_API_GROUP_ID_TC_TO_QUEUE_CFG = 196, 
    BCMOLT_API_GROUP_ID_TM_QMP_KEY = 197, 
    BCMOLT_API_GROUP_ID_TM_QMP_CFG = 198, 
    BCMOLT_API_GROUP_ID_TM_QUEUE_KEY = 199, 
    BCMOLT_API_GROUP_ID_TM_QUEUE_CFG = 200, 
    BCMOLT_API_GROUP_ID_TM_SCHED_KEY = 201, 
    BCMOLT_API_GROUP_ID_TM_SCHED_CFG = 202, 
...
#define bcmolt_device_auto_subgroup_full_mask 0x7FF
...
typedef enum
{
    ...
    BCMOLT_FLOW_AUTO_SUBGROUP_ALL = 0, 
    BCMOLT_FLOW_AUTO_SUBGROUP_RECEIVE_ETH_PACKET = 1, 
    BCMOLT_FLOW_AUTO_SUBGROUP__NUM_OF, 
...
#define bcmolt_flow_auto_subgroup_receive_eth_packet BCMOLT_FLOW_AUTO_SUBGROUP_RECEIVE_ETH_PACKET
...
#define bcmolt_flow_auto_subgroup_full_mask 0x3
...
typedef enum
{
    ...
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_LOS = 6, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_ONU_DISCOVERED = 7, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_ONU_UPGRADE_COMPLETE = 8, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_PROTECTION_SWITCHING_ONUS_RANGED = 9, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_PROTECTION_SWITCHING_RERANGE_FAILURE = 10, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_PROTECTION_SWITCHING_SWITCHOVER_COMPLETED = 11, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_PROTECTION_SWITCHING_TRAFFIC_RESUME = 12, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_SERIAL_NUMBER_ACQUISITION_CYCLE_START = 13, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_STANDBY_PON_MONITORING_CYCLE_COMPLETED = 14, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_STATE_CHANGE_COMPLETED = 15, 
    BCMOLT_PON_INTERFACE_AUTO_SUBGROUP_TOD_REQUEST_COMPLETED = 16, 
...
#define bcmolt_pon_interface_auto_subgroup_full_mask 0x1FFFF
...
#define bcmolt_action_id_full_mask 0x1F
...
#define bcmolt_classifier_id_full_mask 0x3FFF
...
typedef enum
{
    ...
    BCMOLT_ERPS_INTF_REF_ID_PRIORITY = 1, 
...
#define bcmolt_erps_intf_ref_id_priority BCMOLT_ERPS_INTF_REF_ID_PRIORITY
...
#define bcmolt_erps_intf_ref_id_full_mask 0x7
...
#define bcmolt_host_sw_version_id_full_mask 0x17
...
typedef enum
{
    ...
    BCMOLT_PROTECTION_TYPE_ID_ID = 1, 
...
#define bcmolt_protection_type_id_id BCMOLT_PROTECTION_TYPE_ID_ID
...
#define bcmolt_protection_type_id_full_mask 0x3
...
#define bcmolt_device_cfg_data_id_full_mask 0x383F3EFF
...
#define bcmolt_device_connect_data_id_full_mask 0x2F
...
#define bcmolt_device_auto_cfg_data_id_full_mask 0x3FF
...
typedef enum
{
    ...
    BCMOLT_ETH_OAM_CFG_DATA_ID_FLOW_ID = 4, 
    BCMOLT_ETH_OAM_CFG_DATA_ID_STATE = 5, 
    BCMOLT_ETH_OAM_CFG_DATA_ID_SOURCE_MAC = 8, 
    BCMOLT_ETH_OAM_CFG_DATA_ID_DEST_MAC = 9, 
    BCMOLT_ETH_OAM_CFG_DATA_ID_TAG_COUNT = 10, 
    BCMOLT_ETH_OAM_CFG_DATA_ID_OUTER_TAG = 11, 
    BCMOLT_ETH_OAM_CFG_DATA_ID_OUTER_PCP = 12, 
    BCMOLT_ETH_OAM_CFG_DATA_ID_OUTER_TPID = 13, 
    BCMOLT_ETH_OAM_CFG_DATA_ID_INNER_TAG = 14, 
    BCMOLT_ETH_OAM_CFG_DATA_ID_INNER_PCP = 15, 
    BCMOLT_ETH_OAM_CFG_DATA_ID_INNER_TPID = 16, 
...
#define bcmolt_eth_oam_cfg_data_id_flow_id BCMOLT_ETH_OAM_CFG_DATA_ID_FLOW_ID
...
#define bcmolt_eth_oam_cfg_data_id_tag_count BCMOLT_ETH_OAM_CFG_DATA_ID_TAG_COUNT
#define bcmolt_eth_oam_cfg_data_id_outer_tag BCMOLT_ETH_OAM_CFG_DATA_ID_OUTER_TAG
#define bcmolt_eth_oam_cfg_data_id_outer_pcp BCMOLT_ETH_OAM_CFG_DATA_ID_OUTER_PCP
#define bcmolt_eth_oam_cfg_data_id_outer_tpid BCMOLT_ETH_OAM_CFG_DATA_ID_OUTER_TPID
#define bcmolt_eth_oam_cfg_data_id_inner_tag BCMOLT_ETH_OAM_CFG_DATA_ID_INNER_TAG
#define bcmolt_eth_oam_cfg_data_id_inner_pcp BCMOLT_ETH_OAM_CFG_DATA_ID_INNER_PCP
#define bcmolt_eth_oam_cfg_data_id_inner_tpid BCMOLT_ETH_OAM_CFG_DATA_ID_INNER_TPID
...
#define bcmolt_eth_oam_cfg_data_id_full_mask 0x3FF37
...
typedef enum
{
    BCMOLT_FLOW_RECEIVE_ETH_PACKET_DATA_ID__BEGIN = 1,
    BCMOLT_FLOW_RECEIVE_ETH_PACKET_DATA_ID_BUFFER = 1, 
    BCMOLT_FLOW_RECEIVE_ETH_PACKET_DATA_ID__NUM_OF, 

    
#define bcmolt_flow_receive_eth_packet_data_id__begin BCMOLT_FLOW_RECEIVE_ETH_PACKET_DATA_ID__BEGIN
#define bcmolt_flow_receive_eth_packet_data_id_buffer BCMOLT_FLOW_RECEIVE_ETH_PACKET_DATA_ID_BUFFER
#define bcmolt_flow_receive_eth_packet_data_id__num_of BCMOLT_FLOW_RECEIVE_ETH_PACKET_DATA_ID__NUM_OF
#define bcmolt_flow_receive_eth_packet_data_id_all_properties 0xFF
#define bcmolt_flow_receive_eth_packet_data_id_full_mask 0x2

} bcmolt_flow_receive_eth_packet_data_id;


typedef enum
{
    BCMOLT_FLOW_AUTO_CFG_DATA_ID__BEGIN = 0,
    BCMOLT_FLOW_AUTO_CFG_DATA_ID_RECEIVE_ETH_PACKET = 0, 
    BCMOLT_FLOW_AUTO_CFG_DATA_ID__NUM_OF, 

    
#define bcmolt_flow_auto_cfg_data_id__begin BCMOLT_FLOW_AUTO_CFG_DATA_ID__BEGIN
#define bcmolt_flow_auto_cfg_data_id_receive_eth_packet BCMOLT_FLOW_AUTO_CFG_DATA_ID_RECEIVE_ETH_PACKET
...
#define bcmolt_flow_auto_cfg_data_id_full_mask 0x1
...
typedef enum
{
    ...
    BCMOLT_NNI_INTERFACE_CFG_DATA_ID_STATE = 0, 
...
#define bcmolt_nni_interface_cfg_data_id_full_mask 0x39
...
typedef enum
{
    ...
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_LOS = 5, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_ONU_DISCOVERED = 6, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_ONU_UPGRADE_COMPLETE = 7, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_PROTECTION_SWITCHING_ONUS_RANGED = 8, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_PROTECTION_SWITCHING_RERANGE_FAILURE = 9, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_PROTECTION_SWITCHING_SWITCHOVER_COMPLETED = 10, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_PROTECTION_SWITCHING_TRAFFIC_RESUME = 11, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_SERIAL_NUMBER_ACQUISITION_CYCLE_START = 12, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_STANDBY_PON_MONITORING_CYCLE_COMPLETED = 13, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_STATE_CHANGE_COMPLETED = 14, 
    BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_ID_TOD_REQUEST_COMPLETED = 15, 
...
#define bcmolt_pon_interface_auto_cfg_data_id_full_mask 0xFFFF
...
typedef enum
{
    ...
    BCMOLT_TM_SCHED_CFG_DATA_ID_STATE = 4, 
...
#define bcmolt_tm_sched_cfg_data_id_full_mask 0x1F
