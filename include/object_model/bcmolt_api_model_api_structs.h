...
#define BCMOLT_DEVICE_CFG_DATA_PRESENCE_MASK_ALL 0x00000000383F3EFFULL
...
#define BCMOLT_DEVICE_CONNECT_DATA_PRESENCE_MASK_ALL 0x000000000000002FULL
...
#define BCMOLT_DEVICE_AUTO_CFG_DATA_PRESENCE_MASK_ALL 0x00000000000003FFULL
...
typedef struct
{
    ...
    uint8_t tag_count; 
    bcmolt_vlan_id outer_tag; 
    uint8_t outer_pcp; 
    uint16_t outer_tpid; 
    bcmolt_vlan_id inner_tag; 
    uint8_t inner_pcp; 
    uint16_t inner_tpid; 
} bcmolt_eth_oam_cfg_data;


#define BCMOLT_ETH_OAM_CFG_DATA_PRESENCE_MASK_ALL 0x000000000003FF37ULL
...
typedef struct
{
    bcmolt_presence_mask presence_mask;
    bcmolt_bin_str buffer; 
} bcmolt_flow_receive_eth_packet_data;


#define BCMOLT_FLOW_RECEIVE_ETH_PACKET_DATA_PRESENCE_MASK_ALL 0x0000000000000002ULL
...
typedef struct
{
    bcmolt_auto hdr; 
    bcmolt_flow_key key; 
    bcmolt_flow_receive_eth_packet_data data; 
} bcmolt_flow_receive_eth_packet;
...
#define BCMOLT_FLOW_AUTO_CFG_DATA_PRESENCE_MASK_ALL 0x0000000000000001ULL
...
typedef struct
{
    bcmolt_auto_cfg hdr; 
    bcmolt_flow_key key; 
    bcmolt_flow_auto_cfg_data data; 
...
#define BCMOLT_NNI_INTERFACE_CFG_DATA_PRESENCE_MASK_ALL 0x0000000000000039ULL
...
#define BCMOLT_PON_INTERFACE_AUTO_CFG_DATA_PRESENCE_MASK_ALL 0x000000000000FFFFULL
...
#define BCMOLT_TM_SCHED_CFG_DATA_PRESENCE_MASK_ALL 0x000000000000001FULL
