...
#define BCMOLT_ACTION_PRESENCE_MASK_ALL 0x000000000000001FULL
...
#define BCMOLT_CLASSIFIER_PRESENCE_MASK_ALL 0x0000000000003FFFULL
...
#define BCMOLT_ERPS_INTF_REF_PRESENCE_MASK_ALL 0x0000000000000007ULL
...
#define BCMOLT_HOST_SW_VERSION_PRESENCE_MASK_ALL 0x0000000000000017ULL
...
#define BCMOLT_PROTECTION_TYPE_PRESENCE_MASK_ALL 0x0000000000000003ULL
...
typedef struct
{
    ...
    uint8_t us_mse; 
    bcmolt_calibration_record loose_calibration_bound; 
    uint16_t fsr; 
